...
\begin{document}
	...
	La hipótesis central es que si una red \enquote{entiende} el marco teórico de caída libre, deberá ser capaz de:
	\begin{enumerate}
	...
	\begin{itemize}
		\item \textbf{Red simple 1$\rightarrow$2$\rightarrow$1}: Recibe \textit{solo el tiempo}. Esta red debe \enquote{reinventar} la relación cuadrática sin ayuda explícita. Es la prueba más exigente de si la red puede descubrir el marco teórico.
	...
	\begin{itemize}
		...
		\item Este éxito en la estimación de $g$ puede ser evidencia clara de que las redes \textbf{han aprendido el marco teórico} de caída libre, no patrones diferentes.
	\end{itemize}
	...
	\begin{enumerate}
		...
		\item \textbf{Ruido en los datos}: Los datos contienen irregularidades, perturbaciones, etc. La red intenta minimizar este ruido pero no puede separarlo del patrón físico.
	...
	\begin{enumerate}
		...
		\item No necesita \enquote{redescubrir} la estructura cuadrática; la estructura física le viene dada implícitamente en los datos de entrada.
	\end{enumerate}
	...
	\begin{itemize}
		\item Entrenar con datos de sistemas que tengan diferentes valores de $g$ y verificar que las redes estimen correctamente cada uno.
